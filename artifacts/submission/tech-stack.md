...
- Frontend: React 19, TypeScript 5.8, Vite 6, custom responsive CSS, Lucide icons, DM Sans and Manrope.
- Audit: Python 3.11 standard library (Decimal, json, csv, hashlib, unittest).
